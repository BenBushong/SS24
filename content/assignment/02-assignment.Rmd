...
```{r}
# NOTE: the assignment doesn't match the template tha tis used (lab-02.rmd). Remove the template part!
```
:::fyi

**NOTE**

You must turn in a PDF document of your `R Markdown` code. Submit this to D2L by 11:59 PM Eastern Time on Monday, September 18th.
