...
- [<i class="fas fa-file-download"></i> Weekly writing template](https://raw.githubusercontent.com/ajkirkpatrick/FS20/postS21_rev/Rmarkdown_templates/SSC442_Weekly_Writing_Template.Rmd)

- [<i class="fas fa-file-download"></i> Lab assignment template](https://raw.githubusercontent.com/ajkirkpatrick/FS20/postS21_rev/Rmarkdown_templates/SSC442_Lab_Assignment_Template.Rmd)
...
You will turn these labs in via D2L. You will write them using `R Markdown` and this[<i class="fas fa-file-download"></i> lab assignment template](https://raw.githubusercontent.com/ajkirkpatrick/FS20/postS21_rev/Rmarkdown_templates/SSC442_Lab_Assignment_Template.Rmd). You must `knit` your work to a PDF document (this will be what you turn in). 
