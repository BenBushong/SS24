...
You will turn these labs in via D2L. You will write them using `R Markdown` and this[<i class="fas fa-file-download"></i> lab assignment template](/files/SSC442_Lab_Assignment_Template.Rmd). You must `knit` your work to a PDF document (this will be what you turn in). 
