...
You must turn in a PDF document of your `R Markdown` code. Submit this to D2L by 11:59 PM Eastern Time on Monday, October 31st 
...
1. Using any method you choose and any number of regressors, predict `SalePrice` with no fewer than five models of increasing complexity. Complexity can be increased by adding variables *or* by adding interactions of existing variables. Put the five models into a list.
