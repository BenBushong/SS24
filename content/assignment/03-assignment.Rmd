...
You must turn in a PDF document of your `R Markdown` code. Submit this to D2L by 11:59 PM Eastern Time on Monday, February 5th.
...
[The example for this week](/example/03-example/) will be ***incredibly*** helpful for this exercise. Reference it.
...
- This plot might be big, so make sure you adjust `fig.width` and `fig.height` in the chunk options so that it's visible when you knit it - try different values and knit to see how they look. If you're unfamiliar with chunk options, [see the Using R Markdown resources](https://ssc442kirkpatrick.netlify.app/resource/rmarkdown/#chunk-options-1). 
