...
3. The `:` symbol allows you to create an interction term between two variables. Use the `:` symbols to fit a linear regression model with *one* well-chosen interaction effects plus your other variables. Why did you select the variables you did, and what was the result?
