...
**Note the changed due date**. As with Project 1, only one group member needs to upload the project to D2L. It **must** contain the names of all group members somewhere near the top.
...
#. **Summarize** the data in a series of clear and simple tables.

#. **Create** two appropriate time-based visualizations based on the data.
