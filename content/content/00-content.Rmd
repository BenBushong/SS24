...
You'll repeat this each week until we're out of labs. If a holiday occurs on a due date, then the assignment or lab is due the next non-holiday day at 11:59pm. You'll also work with your assigned group on the Group Project. We'll assign groups after the drop deadline has passed.
