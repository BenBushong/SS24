...
## Getting Started
Today's lecture will ask you to touch real data during the lecture. Please download the following dataset and load it into `R` (or right-click the address and use that to load into `R`).
