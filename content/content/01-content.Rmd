...
Send this email by **September 21st** and we will assign un-teamed folks at the beginning of the following week. Project 1 is due in mid-October. See [schedule](/schedule/) for all the important project dates.
...
This week's content is split into two "halves": the critical data manipulation information contained below and a more-entertaining discussion of visualization included in the Exercises. This is a pretty big shift in gears, so here's a picture of my dog:

![](/content/01-content_files/Thibodaux.jpg)
:::
