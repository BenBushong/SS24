...
- The subscript $i$ indicates that we have an $X$ realized for every individual in our data
...
**Hoeffding's Inequality** states, loosely, that $\eta$ cannot be too far from $\mu$.
