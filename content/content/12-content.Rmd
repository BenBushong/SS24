...
We can now view all the cases by simply printing them. We don't do that here because there are `r length(problems)` problems, but after surveying them carefully, we see that three patterns can be used to define three large groups within these exceptions.
...
s <- c(yes, no)
```
<!-- ![](/./12-content_files/str_view-4.png) -->
![](./img/str_view-4.png)
...
<!-- ![](/./12-content_files/str_view-5.png) -->
![](./img/str_view-5.png)
