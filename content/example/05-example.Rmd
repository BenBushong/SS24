...
Then we load the data with `read_csv()`. Here we assume that the CSV file lives in a subfolder named `data`:
...
## Lecture Video
The lecture video for Tuesday (this material, but we only made it about 2/3rds of the way) is [available here <i class="fas fa-film"></i>](https://mediaspace.msu.edu/media/SSC442+-+Example+05+-+Feb+17th/1_c66sr1i4)
